Saltee.PhotoSlider = {
  ...
  initialize: function(options)
  {
    ...
    self.carouselIndicatorListSelector = options.carouselIndicatorListSelector||".js-carousel-indicator-list";
    ...
    self.currentCarouselIndicatorsSelector = self.dialogSelector+">"+self.carouselIndicatorListSelector+":first-child";
